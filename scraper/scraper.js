...
const CINEMAS = {
  ...
  'ugc-opera':            { name:'UGC Opéra',                  chain:'ugc',    acId:'C0126', lat:48.8703, lng:2.3340, addr:'32 bd des Italiens, 75009',     metro:'Opéra' },
  'pathe-parnasse':       { name:'Pathé Parnasse Premium',     chain:'pathe',  acId:'C0158', lat:48.8443, lng:2.3232, addr:'11 rue du Départ, 75014',  metro:'Vavin' },
  'ugc-danton':           { name:'UGC Danton',                  chain:'ugc',    acId:'C0102', lat:48.8455, lng:2.3275, addr:'99 bd du Montparnasse, 75006',  metro:'Vavin' },
  'ugc-montparnasse':     { name:'UGC Montparnasse',           chain:'ugc',    acId:'C0103', lat:48.8414, lng:2.3213, addr:'13 rue du Cdt Mouchotte, 75014',metro:'Montparnasse' },
  'ugc-lyon':             { name:'UGC Lyon-Bastille',          chain:'ugc',    acId:'C0146', lat:48.8529, lng:2.3693, addr:'12 rue de Lyon, 75012', metro:'Bastille' },
  'pathe-beaugrenelle':   { name:'Pathé Beaugrenelle',         chain:'pathe',  acId:'W7502', lat:48.846, lng:2.2887, addr:'7 rue Linois, 75015',          metro:'Charles Michels' },
  'pathe-convention':     { name:'Pathé Convention',           chain:'pathe',  acId:'C0161', lat:48.8382, lng:2.3072, addr:'27 rue Alain-Chartier, 75015',  metro:'Convention' },
  'pathe-bnp':            { name:'Pathé BNP Paribas',          chain:'pathe',  acId:'C0060', lat:48.8703, lng:2.337, addr:'32 rue Louis Le Grand, 75002',       metro:'Place de Clichy' },
  'pathe-alesia':         { name:'Pathé Alésia',               chain:'pathe',  acId:'C0037', lat:48.8277, lng:2.3260, addr:'73 av du Gén. Leclerc, 75014',  metro:'Alésia' },
  'pathe-montparnos':   { name:'Pathé Montparnos',         chain:'pathe',  acId:'C0052', lat:48.8394, lng:2.3168, addr:"16 rue d'Odessa, 75014",           metro:'Montparnasse' },
  ...
  'pathe-la-villette':  { name:'Pathé La Villette IMAX',  chain:'pathe',  acId:'W7520', lat:48.8952, lng:2.3869, addr:'211 av Jean Jaurès, 75019',       metro:'Porte de la Villette' },
  'pathe-palace':       { name:'Pathé Palace',             chain:'pathe',  acId:'G02BG', lat:48.8706, lng:2.3314, addr:'2 bd des Capucines, 75009',          metro:'Opéra' },
  'pathe-batignolles':  { name:'Les 7 Batignolles',        chain:'pathe',  acId:'P7517', lat:48.8852, lng:2.3238, addr:'86 rue M. Rostropovitch, 75017',    metro:'Brochant' },
  ...
  'pathe-quai-ivry':   { name:"Pathé Quai d'Ivry IMAX",  chain:'pathe',  acId:'B0258', lat:48.8098, lng:2.3847, addr:'31 quai Ivry, 94200',              metro:'Ivry' },
