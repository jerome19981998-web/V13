...
const CINEMAS = {
  ...
  'ugc-bercy':             { name: 'UGC Ciné Cité Bercy',          chain: 'ugc',     lat: 48.8302, lng: 2.3789, addr: '2 cour Saint-Émilion',      metro: 'Cour St-Émilion', allocineId: 'C0118' },
  'ugc-paris19':           { name: 'UGC Ciné Cité Paris 19',       chain: 'ugc',     lat: 48.8866, lng: 2.3780, addr: '1 rue du Bassin',           metro: 'Corentin Cariou', allocineId: 'C0152' },
  ...
  'ugc-montparnasse':      { name: 'UGC Montparnasse',              chain: 'ugc',     lat: 48.8424, lng: 2.3244, addr: '103 bd du Montparnasse',    metro: 'Vavin',           allocineId: 'C0090' },
  'ugc-lyon':              { name: 'UGC Lyon-Bastille',             chain: 'ugc',     lat: 48.8448, lng: 2.3731, addr: '12 rue de Lyon',            metro: 'Gare de Lyon',    allocineId: 'C0088' },
  'pathe-beaugrenelle':    { name: 'Pathé Beaugrenelle',            chain: 'pathe',   lat: 48.8473, lng: 2.2894, addr: '7 rue Linois',              metro: 'Charles Michels', allocineId: 'C0159' },
  ...
  'pathe-parnasse':        { name: 'Pathé Parnasse',                chain: 'pathe',   lat: 48.8429, lng: 2.3334, addr: '3 rue du Départ',           metro: 'Montparnasse',    allocineId: 'C0114' },
  'pathe-wepler':          { name: 'Pathé Wepler',                  chain: 'pathe',   lat: 48.8842, lng: 2.3272, addr: '14 pl. de Clichy',          metro: 'Place de Clichy', allocineId: 'C0159' },
  ...
  'pathe-batignolles':     { name: 'Les 7 Batignolles',             chain: 'pathe',   lat: 48.8861, lng: 2.3189, addr: '6 rue Hélène',              metro: 'Brochant',        allocineId: 'C0200' },
  'gaumont-opera':         { name: 'Gaumont Opéra Premier',         chain: 'gaumont', lat: 48.8701, lng: 2.3308, addr: '2 bd des Capucines',        metro: 'Opéra',           allocineId: 'B0244' },
